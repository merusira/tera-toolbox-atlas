...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'loader-cli/error-config-corrupt-1': return 'ERROR: Whoops, looks like you\'ve messed up your config.json!';
        ...
        case 'gui/main/title': return 'TERA Atlas';
        ...
        case 'gui/main/static/tabs/credits/content': return 'Thanks to<br />SaltyMonkey: Installer/Modern UI stuff<br />Mathicha &amp; Pentagon: Old GUI stuff<br />Foglio: Logo design<br />Meishu: Original Tera-Proxy Core<br />All Toolbox Translators<br />All Mod Developers<br />merusira';
